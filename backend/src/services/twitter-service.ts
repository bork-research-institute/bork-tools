...
export class TwitterService extends Service {
  ...
  private cacheService: TwitterCacheService;
  private spamService: TwitterSpamService;
  private requestService: TwitterRequestService;
  private targetUsers: string[] = [];

  static get serviceType(): ServiceType {
    return ServiceTypeTwitter.TWITTER_SERVICE as unknown as ServiceType;
  }
