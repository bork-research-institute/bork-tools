...
import { mapTopicWeightRowToTopicWeight } from './mappers/map-topic-weight-row-to-topic-weight.js';
import { tweetAnalysisTemplate } from './templates/analysis.js';
import type { MarketMetrics } from './types/market.js';
import type { TopicWeightRow } from './types/topic.js';
import type { SpamUser, Tweet, TweetAnalysis } from './types/twitter.js';
      ...
      while (retryCount < maxRetries) {
        try {
          const template = tweetAnalysisTemplate({
            ...
            topicWeights: topicWeights.map(mapTopicWeightRowToTopicWeight),
          });
